...
let conf = [
{
    ...
    content : [
		...
		{
			icon : "fa fa-brands fa-slack fa-lg",
		...
		{
			icon : "fa fa-brands fa-github fa-lg",
		...
		{
			icon : "fa fa-brands fa-codepen fa-lg",
		...
		{
			icon : "fa fa-solid fa-diamond fa-lg",
			href : "https://whimsical.com/login/",
            target : "_self",
            color_primary : "#ABB2BF",
            color_secondary : "#cfcfcf"
		},
		{
			icon : "fa fa-brands fa-figma fa-lg",
        ...
        {
			icon : "fa fa-brands fa-dropbox fa-lg",
        ...
        {
			icon : "fa fa-solid fa-calendar-day fa-lg",
...
},
{
	...
	content : [
		...
		{
			icon : "fa fa-brands fa-artstation fa-lg",
		...
		{
			icon : "fa fa-brands fa-discord fa-lg",
		...
		{
			icon : "fa fa-solid fa-paperclip fa-lg",
		...
		{
			icon : "fa fa-solid fa-dice-d20 fa-lg",
			href : "https://zombiefox.github.io/diceRoller/",
            target : "_blank",
            color_primary : "#ABB2BF",
            color_secondary : "#cfcfcf"
		},
		{
			icon : "fa fa-brands fa-dribbble fa-lg",
...
},
{
    icon : "fa fa-code fa-lg",
    icon_color_primary : "#ABB2BF",
    icon_color_secondary : "#E08585",
	title : "Entertainment",
	description : "Films, videos, streams",
	title_color_primary : "#ABB2BF",
	title_color_secondary : "#cfcfcf",
	description_color_primary : "#c0c0c0",
	description_color_secondary : "#E08585",
	content : [
		{
			icon : "fa fa-brands fa-vimeo fa-lg",
...
function parallax() {
    ...
    document.querySelector(".bg").addEventListener("mousemove", e => {
        var wpers = 5; // width move persent 
        var hpers = 10; // height move persent
        ...
        e.currentTarget.style.backgroundPosition = `${50+(width/height*wpers)*(x-width/2)/(width/2)}% ${50+(height/width*hpers)*(y-height/2)/(height/2)}%`;
    });

    //-- S P I N  A N Y  E L E M E N T --//
